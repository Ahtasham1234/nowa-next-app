...
import * as Dashboard3data from "./dashboard3";
import {COLUMNS,DATATABLE,GlobalFilter} from "./dashboard3"
import {
  Breadcrumb,
  Button,
  Card,
              ...
              <Row>
                <div className="col-xl-5 col-lg-6 col-md-12 col-sm-12">
                  <div className="prime-card">
                    <img
                      className="img-fluid"
                      src={"../../../assets/img/png/dashboard8.png"}
                      alt=""
                    />
                  </div>
                </div>
...
Dashboard3com.propTypes = {};

Dashboard3com.defaultProps = {};
