                ...
                <Fragment key={itemi + Math.random() * 100}>
                  ...
                  {Item.Items.map((menuItem, i) => (
                    <li className={`slide ${menuItem.selected ? "is-expanded" : ""}  ${menuItem.active ? "is-expanded" : ""}`} key={i}>
                      {menuItem.type === "link" ? (
                        <Link href={menuItem.path } className={`side-menu__item ${menuItem.selected ? "active" : ""} text-decoration-none`}>
                          {menuItem.icon}
                      ...
                      {menuItem.type === "sub" ? (
                        ...
                        }} className={`side-menu__item ${menuItem.selected ? "active is-expanded" : ""} text-decoration-none`}>
                          {menuItem.icon}
                            ...
                            return (
                              <li key={index} className={`sub-slide ${childrenItem.selected ? "is-expanded" : ""} ${childrenItem.active ? "is-expanded" : ""}`}>
                                {childrenItem.type === "sub" ? (
                                  <a href="javascript"
                                    className={`slide-item ${childrenItem.selected ? "active is-expanded" : ""} text-decoration-none`}
