            ...
            <Row>
              <div className="col">
                ...
                <div className="h3 mt-2 mb-2">
                  <b>19.89K</b>
                  <span className="text-success tx-13 ms-2">(+25%)</span>
                </div>
              </div>
          ...
          <Card.Body>
            <Row>
              <div className="col">
                ...
                <div className="h3 mt-2 mb-2">
                  <b>692</b>
                  <span className="text-success tx-13 ms-2">(+15%)</span>
                </div>
              </div>
              <div className="col-auto align-self-center ">
                <div className="feature mt-0 mb-0">
          ...
          <Card.Body>
            <Row>
              <div className="col">
                ...
                <div className="h3 mt-2 mb-2">
                  <b>286</b>
                  <span className="text-success tx-13 ms-2">(+08%)</span>
                </div>
              </div>
              <div className="col-auto align-self-center ">
                <div className="feature mt-0 mb-0">
        ...
        <Card>
          <Card.Header className=" pb-0">
            ...
            <p className="tx-12 tx-gray-500 mb-3">
              ...
              imagesralized <Link href="#!">Learn more</Link>
            </p>
          </Card.Header>
          <Card.Body>
            <Row>
        ...
        <Card>
          <Card.Header className=" bg-transparent pd-b-0 pd-t-20 bd-b-0">
            ...
            <p className="tx-12 tx-gray-500 mb-0">
              ...
              rating. <Link href="#!">Learn more</Link>
            </p>
          </Card.Header>
          {/* <!-- card-header --> */}
        ...
        <Card className=" order-list">
          <Card.Body>
            ...
            <p className="tx-12 tx-gray-500 mb-3">
              ...
              on their stores <Link href="#!">Learn more</Link>
            </p>
            <ul className="list list-noborders pb-0 mb-0">
              <li className="list-item">
                ...
                <div className="ms-auto d-flex">
                  <img
                    ...
                    src={"../../assets/img/ecommerce/03.jpg"}
                    alt="thumb images"
                  />
                  <img
                    className="img-sm"
                    src={"../../assets/img/ecommerce/08.jpg"}
                    alt="thumb images"
                  />
                </div>
              </li>
              <li className="list-item">
                ...
                <div className="ms-auto d-flex">
                  <img
                    className="img-sm me-1"
                    src={"../../assets/img/ecommerce/04.jpg"}
                    alt="thumb images"
                  />
                  <img
                    className="img-sm"
                    src={"../../assets/img/ecommerce/05.jpg"}
                    alt="thumb images"
                  />
                </div>
              </li>
              <li className="list-item">
                ...
                <div className="ms-auto d-flex">
                  <img
                    className="img-sm me-1"
                    src={"../../assets/img/ecommerce/06.jpg"}
                    alt="thumb images"
                  />
                  <img
                    className="img-sm"
                    src={"../../assets/img/ecommerce/07.jpg"}
                    alt="thumb images"
                  />
                </div>
              </li>
              <li className="list-item">
                ...
                <div className="ms-auto d-flex">
                  ...
                  <img
                    className="img-sm"
                    src={"../../assets/img/ecommerce/09.jpg"}
                    alt="thumb images"
                  />
                </div>
              </li>
